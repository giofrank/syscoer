...
<header class="main-header">
    ...
    <a href="{{ url('/home') }}" class="logo">
        ...
        <span class="logo-lg"><b>COER </b> </span>
    </a>

    <!-- Header Navbar -->
    <nav class="navbar navbar-static-top" role="navigation" style="background-color: #0e5fd8;">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown messages-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="footer"><a href="#">casa</a></li>
                    </ul>
                </li><!-- /.messages-menu -->
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    ...
                                    {{-- {{ Auth::user()->name }} --}}
                                    <small>{{ Auth::user()->codid}} - Nov. 2018</small>
                                </p>
                            </li>
                            <!-- Menu Body -->
{{--                             <li class="user-body">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="#" class="btn btn-default btn-flat">Prefil</a>
                                </div>
